    ...
    <>
      <style>{`
        ...
        .btn-login {
          ...
          color: #1a2e1a; font-size: 14px; font-weight: 500;
        ...
        .hero {
          ...
          text-align: center; padding: 120px 24px 280px;
        }

        .hero-tag {
          font-size: 12px; font-weight: 600; letter-spacing: 3px;
          text-transform: uppercase; color: #2d6a2d; margin-bottom: 16px;
        ...
        .hero-title {
          ...
          font-weight: 700; line-height: 1.05; color: #1a2e1a;
          margin-bottom: 20px;
        ...
        .hero-sub {
          font-size: clamp(15px, 2vw, 19px); color: #3d5a3d;
        ...
        .btn-hero-primary {
          ...
          cursor: pointer; box-shadow: 0 8px 30px rgba(45,90,39,0.35);
        ...
        .btn-hero-secondary {
          ...
          border: 1.5px solid rgba(255,255,255,0.9);
          color: #1a2e1a; font-size: 15px; font-weight: 600;
      ...
      <div className="nature-bg">
        ...
        <section className="hero">
          <p className="hero-tag">🌱 AI Agents for Indian Businesses</p>
          <h1 className="hero-title">Your Business,<br />Always Awake</h1>
          ...
          <div style={{ maxWidth: "900px", margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "16px" }}>
            {[
              ...
              <div key={stat.label} style={{
                ...
                <div style={{ fontFamily: "'Playfair Display', serif", fontSize: "28px", fontWeight: "700", color: "#1a2e1a" }}>{stat.value}</div>
                <div style={{ fontSize: "13px", color: "#5a7a5a", marginTop: "4px" }}>{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="section-bg">
          <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
            <div style={{ textAlign: "center", marginBottom: "50px" }}>
              <p style={{ fontSize: "12px", fontWeight: "600", letterSpacing: "3px", textTransform: "uppercase", color: "#2d6a2d", marginBottom: "12px" }}>
                🤖 Our AI Agents
              </p>
              <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(28px, 5vw, 46px)", fontWeight: "700", color: "#1a2e1a", marginBottom: "14px" }}>
                Pick Your Agent, We Do the Rest
              </h2>
              <p style={{ color: "#5a7a5a", fontSize: "16px", maxWidth: "500px", margin: "0 auto", lineHeight: "1.7" }}>
                Set it up once and let AI handle your customers around the clock.
              </p>
            </div>
              ...
              {[
                {
                  icon: "💬",
                  name: "WhatsApp Agent",
                  desc: "Customers message you on WhatsApp — AI replies instantly. Handles queries, timings, bookings, and everything in between. Works round the clock so you don't have to.",
                  tag: "Most Popular",
                  tagColor: "#25D366",
                  slug: "whatsapp-agent",
                  features: ["Auto-replies 24/7", "Answers FAQs", "Books appointments", "Hindi & English"]
                },
                {
                  icon: "📧",
                  name: "Email Agent",
                  desc: "Every customer email gets a smart, professional reply within seconds. No more long email backlogs or missed inquiries — your AI handles it all.",
                  tag: "New",
                  tagColor: "#4a9eff",
                  slug: "email-agent",
                  features: ["Instant email replies", "Professional tone", "Any email service", "Conversation history"]
                },
              ].map((agent) => (
                <div
                  key={agent.slug}
                  ...
                  onClick={() => {
                    if (user) {
                      window.location.href = agent.slug === "whatsapp-agent"
                ...
                >
                  {agent.tag && (
                    <span style={{
                      ...
                      background: agent.tagColor, color: "white",
                  ...
                  <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: "24px", fontWeight: "700", color: "#1a2e1a", marginBottom: "10px" }}>
                    {agent.name}
                  </h3>
                  <p style={{ color: "#5a7a5a", fontSize: "14px", lineHeight: "1.7", marginBottom: "20px" }}>
                    {agent.desc}
                  </p>
                  <div style={{ display: "flex", flexWrap: "wrap", gap: "8px", marginBottom: "20px" }}>
                    {agent.features.map((f) => (
                      <span key={f} style={{
                        ...
                        color: "#2d5a27", fontSize: "12px", fontWeight: "500",
                        padding: "4px 10px", borderRadius: "50px"
                      }}>✓ {f}</span>
                    ))}
                  </div>
                  <div style={{ display: "flex", alignItems: "center", color: "#2d5a27", fontSize: "13px", fontWeight: "600", gap: "6px" }}>
                    {user ? "Set it up →" : "Sign up to try →"}
                  </div>
                </div>
              ))}
            </div>
        ...
        <div style={{ position: "relative", zIndex: 10, padding: "80px 24px" }}>
          <div style={{ maxWidth: "900px", margin: "0 auto" }}>
            <div style={{ textAlign: "center", marginBottom: "50px" }}>
              ...
              <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(28px, 5vw, 42px)", fontWeight: "700", color: "#1a2e1a" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "20px" }}>
              {[
                ...
                { step: "02", icon: "⚙️", title: "We set it up", desc: "Our team activates your agent within 24 hours. No technical work needed from your side." },
                { step: "03", icon: "🤖", title: "AI goes live", desc: "Your agent starts replying to customers automatically — day and night." },
                { step: "04", icon: "📈", title: "You grow", desc: "Focus on your actual work while AI handles all the incoming queries." },
              ].map((item) => (
        ...
        {/* CTA Section */}
        <div style={{ position: "relative", zIndex: 10, padding: "80px 24px 300px", textAlign: "center" }}>
          <div style={{ maxWidth: "600px", margin: "0 auto" }}>
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(28px, 5vw, 46px)", fontWeight: "700", color: "#1a2e1a", marginBottom: "16px" }}>
              Ready to stop missing customers?
            </h2>
            <p style={{ color: "#5a7a5a", fontSize: "16px", lineHeight: "1.7", marginBottom: "36px" }}>
              Join businesses that never miss a customer inquiry — even at 2am.
            </p>
            {!user ? (
              <button className="btn-hero-primary" onClick={() => openAuth("signup")} style={{ fontSize: "16px", padding: "16px 44px" }}>
                Get Started Free 🌿
              </button>
            ) : (
              <Link href="/dashboard" className="btn-hero-primary" style={{ textDecoration: "none", display: "inline-block", fontSize: "16px", padding: "16px 44px" }}>
                Go to Dashboard 🌿
              </Link>
            )}
          </div>
