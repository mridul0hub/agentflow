        ...
        <div className="setup-content fade-up" style={{ padding: "40px 32px", maxWidth: "720px", margin: "0 auto" }}>
          ...
          <div style={{ marginBottom: "32px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "8px" }}>
              <div style={{ width: "48px", height: "48px", background: "rgba(59,130,246,0.12)", borderRadius: "14px", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "26px" }}>📧</div>
              <div>
                ...
                <p style={{ color: "#5a7a5a", fontSize: "14px", margin: "3px 0 0" }}>
                  Fill in your business details — AI will use this to reply to customer emails
                </p>
              </div>
            </div>
          ...
          <div className="form-card">
            ...
            {saved && (
              <div style={{ background: "rgba(37,211,102,0.1)", border: "1px solid rgba(37,211,102,0.3)", color: "#16a34a", padding: "12px 16px", borderRadius: "12px", marginBottom: "20px", fontSize: "13px", fontWeight: "600" }}>
                ✅ Email agent details saved successfully!
              </div>
            )}
            ...
            <div className="form-group">
              ...
              <input className="form-input" name="business_name" value={form.business_name}
                onChange={handleChange} placeholder="e.g. Dr. Sharma Skin Clinic" />
              <p className="form-hint">AI will introduce your business with this name</p>
            </div>

            {/* Business Email */}
            <div className="form-group">
              <label className="form-label">Business Email Address <span>*</span></label>
              <input className="form-input" name="business_email" value={form.business_email}
                onChange={handleChange} placeholder="e.g. info@drsharma.com or drsharma@gmail.com" type="email" />
              <p className="form-hint">Customer emails sent to this address will be auto-replied by AI</p>
            </div>

            {/* Timings */}
            <div className="form-group">
              <label className="form-label">Business Timings</label>
              <input className="form-input" name="timings" value={form.timings}
                onChange={handleChange} placeholder="e.g. Monday to Saturday 10am - 8pm, Sunday Closed" />
            ...
            <div className="form-group">
              ...
              <textarea className="form-input" name="services" value={form.services}
                onChange={handleChange} placeholder="e.g. Acne treatment, Hair fall, Skin allergy, Pigmentation" rows={3} />
            ...
            <div className="form-group">
              ...
              <textarea className="form-input" name="fees" value={form.fees}
                onChange={handleChange} placeholder="e.g. Consultation ₹500, Follow-up ₹300" rows={2} />
            ...
            <div className="form-group">
              ...
              <input className="form-input" name="location" value={form.location}
                onChange={handleChange} placeholder="e.g. Near City Mall, Kota, Rajasthan" />
            ...
            <div className="form-group">
              ...
              <textarea className="form-input" name="extra_info" value={form.extra_info}
                onChange={handleChange}
                placeholder="e.g. We accept Cash and UPI. Home visits available. Book appointments via email."
                rows={4} />
          ...
          {/* Info Cards */}
          <div className="info-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginTop: "24px" }}>
            {[
              { icon: "🤖", title: "AI Powered", desc: "Gemini AI replies to every customer email instantly" },
              { icon: "📧", title: "Any Email", desc: "Works with Gmail, Outlook, or any custom domain email" },
